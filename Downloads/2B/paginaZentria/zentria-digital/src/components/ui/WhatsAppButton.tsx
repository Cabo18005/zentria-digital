export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-[100] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 hover:bg-[#128C7E] transition-all duration-300 group flex items-center gap-3"
      aria-label="Contactar por WhatsApp"
    >
      {/* Texto que aparece al pasar el mouse (Desktop) */}
